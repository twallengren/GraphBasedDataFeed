...
/**
 *
 * @param <X> - preprocessing data type
 * @param <Y> - aggregating data type
 * @param <Z> - transform type (data type generated by X and aggregated into Y).
 */
public class DataFeedNetwork<X,Y> extends AbstractNetwork {
    ...
    public static class Builder<X,Y> {
        ...
        public <Z> Builder<X,Y> addNode(String nodeId, Function<X,X> preProcessingFunction, Function<X,Z> dataTransferFunction, BiFunction<Z,Y,Y> aggregatingFunction, BiFunction<X,Y,Boolean> triggerFunction) {
